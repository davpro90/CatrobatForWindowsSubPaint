    ...
    public class CommandManager
    {
        ...
        public void UnDo()
        {
            ...
            if (HasCommands())
            {
                ...
                if (command is CropCommand || command is FlipCommand ||
                    command is RotateCommand || command is RemoveCommand)
                {
                    ...
                    if (lastCommand || command is CropCommand ||
                        command is RemoveCommand || command is RotateCommand) 
                    {
                        command.UnDo();
                    }
                }
